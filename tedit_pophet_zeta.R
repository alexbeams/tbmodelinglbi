...
# Just dialing up susceptibility independently  

# This simulates the pophet model under Case 2: the group with elevated susceptibility
# is rare in the overall population, but over-represented in the data because of elevated
# susceptibility

# By independently dialing up altered susceptibility, we mimic the sims where we dial up
# theta independently
...
for(outind in siminds){
 outpath <- paste0('sims/pophetmodel/susceptibility/case2/theta1/',outind,'.txt')
 ...
 out <-  sir_simu(
    ...
    nTrials = 100)
 # Save the seed:
 writeLines(as.character(out$seed), paste0('sims/pophetmodel/susceptibility/case2/theta1/seed',outind,'.txt'))
...
for(outind in siminds){
 outpath <- paste0('sims/pophetmodel/susceptibility/case2/theta2/',outind,'.txt')
 ...
 out <-  sir_simu(
    ...
    nTrials = 100)
 # Save the seed:
 writeLines(as.character(out$seed), paste0('sims/pophetmodel/susceptibility/case2/theta2/seed',outind,'.txt'))
